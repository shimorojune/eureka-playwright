      ...
      for (const otherPackage of this._packages) {
        if (
          ...
          switch (otherPackage.name) {
            case "playwright":
              pkg.packageJSON.dependencies[otherPackage.name] = `https://github.com/eureka-egain/eureka/releases/download/${versionFromParams}/pw.tgz`;
              break;
            case "playwright-core":
              pkg.packageJSON.dependencies[otherPackage.name] = `https://github.com/eureka-egain/eureka/releases/download/${versionFromParams}/pw-core.tgz`;
              break;
            default:
        ...
        if (
          ...
          switch (otherPackage.name) {
            case "playwright":
              pkg.packageJSON.devDependencies[otherPackage.name] = `https://github.com/eureka-egain/eureka/releases/download/${versionFromParams}/pw.tgz`;
              break;
            case "playwright-core":
              pkg.packageJSON.devDependencies[otherPackage.name] = `https://github.com/eureka-egain/eureka/releases/download/${versionFromParams}/pw-core.tgz`;
              break;
            default:
